...
import org.btcprivate.wallets.fullnode.daemon.BTCPInstallationObserver.*;
import org.btcprivate.wallets.fullnode.daemon.CommandExecutor;
...
public class IPFSWrapper {
    ...
    public String shareFileViaIPFS()
        ...
        try {
            ...
            String pathParameter = BTCPClientCaller.wrapStringParameter(f.getCanonicalPath());
    ...
    private boolean getUserConsentToStartIPFS()
        ...
        int option = JOptionPane.showOptionDialog(
                ...
                "This operation will start an IPFS server on your PC to enable file sharing.\n" +
                        ...
                        "The IPFS server will be stopped automatically if you quit the Bitcoin Private wallet. To\n" +
...
// TODO: firewalled warning
    ...
    private DaemonInfo getIPFSDaemonInfo()
        ...
        if (os == OS_TYPE.WINDOWS) {
            return BTCPInstallationObserver.getDaemonInfoForWindowsOS("ipfs");
        } else {
            return BTCPInstallationObserver.getDaemonInfoForUNIXLikeOS("ipfs");
        }
    }
