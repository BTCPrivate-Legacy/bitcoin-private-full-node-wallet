...
public class BTCPWalletUI extends JFrame
{
    ...
    public BTCPWalletUI(StartupProgressDialog progressDialog)
            ...
            throws IOException
    {
        try
        {
            ...
            BTCPWalletUI ui = new BTCPWalletUI(startupBar);
            ui.setVisible(true);
    ...
    private static List<String> getAddNodes() {
        ...
        InputStream is = BTCPWalletUI.class.getResourceAsStream("/config/addnodes.txt");
