...
public class SendCashPanel
  ...
  private static final String LOCAL_MSG_SEND_BTCP_FROM = Util.local("LOCAL_MSG_SEND_BTCP_FROM");
  private static final String LOCAL_MSG_SEND_BTCP_ONLY_CONFIRMED = Util.local("LOCAL_MSG_SEND_BTCP_ONLY_CONFIRMED");
