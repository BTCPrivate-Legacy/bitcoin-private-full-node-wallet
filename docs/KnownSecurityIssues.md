## [BitcoinPrivate](https://btcprivate.org/) Desktop GUI Wallet known security issues
...
The Bitcoin Private Desktop GUI Wallet is not compatible with applications that modify the ZEN `wallet.dat` file. The wallet should not be used
